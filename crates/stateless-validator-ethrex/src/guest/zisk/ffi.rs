// Copied and modified from https://github.com/0xPolygonHermez/zisk-eth-client/blob/v0.7.0/crates/guest-reth/src/crypto/ffi.rs.
...
unsafe extern "C" {
    ...
    pub fn syscall_arith256_mod(params: &mut SyscallArith256ModParams<'_>);
}
