// Copied and modified from https://github.com/hecmas/ethrex/blob/zisk-update/crates/guest-program/src/crypto/zisk.rs.
...
impl Crypto for ZiskCrypto {
    ...
    fn bls12_381_pairing_check(
        ...
        match ret_code {
            ...
            3 => Err(CryptoError::Other(
                "bls12_381_pairing_check G1 point not on curve".to_string(),
            )),
            4 => Err(CryptoError::Other(
                "bls12_381_pairing_check G1 point not in subgroup".to_string(),
            )),
            5 => Err(CryptoError::Other(
                "bls12_381_pairing_check G2 inputs not in field".to_string(),
            )),
            6 => Err(CryptoError::Other(
                "bls12_381_pairing_check G2 point not on curve".to_string(),
            )),
            7 => Err(CryptoError::Other(
                "bls12_381_pairing_check G2 point not in subgroup".to_string(),
            )),
